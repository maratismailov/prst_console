...
//luca
#ifndef GRIDLIB_H_DEF
#define GRIDLIB_H_DEF


#define PACKAGE  "NonLinLoc"
#define PVER  "4.30.0"
#define PDATE "09JAN2007"
...
//luca
extern INLINE float ReadAbsGrid3dValue(/*FILE*, */GridDesc* , double , double ,
		double , int );
...
//luca
extern INLINE float ReadGrid3dValue(/*FILE *,*/ int , int , int , GridDesc* );
...
INLINE float InterpCubeAngles(DOUBLE , DOUBLE , DOUBLE , DOUBLE , DOUBLE ,
		DOUBLE , DOUBLE , DOUBLE , DOUBLE , DOUBLE , DOUBLE );
//luca
extern INLINE float ReadAbsInterpGrid3d(/*FILE *,*/ GridDesc* , double , double ,
		double );
INLINE DOUBLE InterpSquareLagrange(DOUBLE , DOUBLE ,
		DOUBLE , DOUBLE , DOUBLE , DOUBLE );
//luca
extern INLINE DOUBLE ReadAbsInterpGrid2d(/*FILE *,*/ GridDesc* ,
		double , double );
