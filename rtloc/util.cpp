...
//luca
char package_name[MAXLINE] = "RTLoc for PRESTo";
char prog_name[MAXLINE] = "RTLOC";
char prog_ver[MAXLINE] = "0.466";
char prog_date[MAXLINE] = "2009-05-28";
char prog_copyright[MAXLINE] = "(C) Claudio Satriano";
int message_flag = 0;
