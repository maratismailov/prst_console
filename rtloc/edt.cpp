...
extern INLINE double do_edt (double tta, double ttb, double ta, double tb)
{
	double edt;
	double tt1, tt2;
	double t1, t2;
...
//luca
/*
extern INLINE double normalize (double edt, int nsta)
{
	double fedt;
...
*/
extern INLINE double normalize (double edt, double nsta)
{
	return (edt / nsta);
}
